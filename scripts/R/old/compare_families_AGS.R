...
#samp.abund.map <- "Abundance_Map_cid_7_aid_3.tab-filtered-DATA_TYPE-metatranscriptome-AGS_normalized.tab"
#metadata.tab  <- "sample_metadata_mod.tab-filtered-metatranscriptome"
...
autodetect <- function( val.list, cont.thresh, force=NULL) {
...
ra.map$REL.ABUND <- NULL #don't need the relative abundance for AGS calculation
